...
const features = [
  ...
  },
  {
    ...
    description:
      'Intelligent email system that crafts and sends highly personalized outreach campaigns to your leads, maximizing response rates.',
    detailedDescription:
      'Advanced AI-powered email automation that goes beyond traditional mail merges. Our system researches prospects, crafts highly personalized messages, A/B tests content, and automatically adjusts sending times for optimal engagement. It handles follow-ups intelligently and integrates with your sales pipeline for seamless lead nurturing.',
    stat: '85% open rate',
  },
  {
    icon: MessageSquare,
    title: 'AI Chatbot',
    description:
      'Smart conversational AI that engages visitors, answers questions, and captures qualified leads around the clock.',
    detailedDescription:
